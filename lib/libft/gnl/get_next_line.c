...
/*   Updated: 2025/09/10 22:01:14 by ldurmish         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "include/get_next_line.h"

int	ft_read_list(int fd, t_list_gnl **head)
{
	char	*buffer;
	int		bytes_read;
...
char	*ft_split_node(t_list_gnl *list)
{
	char	*line_part;
	char	*rest;
	int		len;
...
char	*process_newline(t_list_gnl *current, t_glfl *glfl)
{
...
char	*ft_get_line_from_list(t_list_gnl **head, t_list_gnl *current)
{
	t_glfl	glfl;
